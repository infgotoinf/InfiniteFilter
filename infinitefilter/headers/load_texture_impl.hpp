                         ...
                         , SDL_Texture** out_texture, int* out_width, int* out_height)
{
    ...
    SDL_Surface* surface = SDL_CreateRGBSurfaceFrom(
          (void*)image_data, image_width, image_height
        , image_channels * 8, image_channels * image_width
...
bool loadTextureFromFile(const char* file_name, SDL_Renderer* renderer, SDL_Texture** out_texture
